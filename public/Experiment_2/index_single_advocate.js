...
var wrote_notes_screen_single = {
  ...
  html: '<div style="text-align:left;margin:0 auto;max-width:600px;">' +
        ...
        '</div>',
  data: { version: 'post_task_single', survey: 'wrote_notes_single' },
...
// Build the single Advocate trial
...
authReady
  .then(async uid => {
    docRef = doc(db, 'spin_task', 'experiment2_single_advocate', 'subjects', uid);
