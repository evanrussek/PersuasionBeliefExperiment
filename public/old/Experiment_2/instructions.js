...
// add a condition for multi-trial judge condition where sticks are picked by computer
...
var computer_picks_sticks_ex = false; // if true, the computer will pick the sticks for the judge
...
if (window.location.search.indexOf('COMPUTER_PICKS') > -1) {
  var computer_picks = getQueryVariable('COVERED') === "true";
}else{
  var computer_picks = computer_picks_sticks_ex; // "single", or "multi"
}
